...
//			echo 'yewuyuan: '.$admin_member_id;
    ...
    {   
        ...
        $wherey[]=array("branch"=>array('in',array(7,8,32)),'type'=>1);
        $bayb=M("cash")->where(array("branch"=>array('in',array(7,8,32)),'type'=>1))->sum("money");
        ...
        $whereysd[]=array("branch"=>array('in',array(7,8,32)),'type'=>2);
        $bayb=M("cash")->where(array("branch"=>array('in',array(7,8,32)),'type'=>2))->sum("money");
        ...
        $wheree[]=array("branch"=>array('in',array(16,17,34)),'type'=>1);
        $baeb=M("cash")->where(array("branch"=>array('in',array(16,17,34)),'type'=>1))->sum("money");
        ...
        $whereesd[]=array("branch"=>array('in',array(16,17,34)),'type'=>2);
        $baeb=M("cash")->where(array("branch"=>array('in',array(16,17,34)),'type'=>2))->sum("money");
        ...
        $where[]=array("branch"=>array('in',array(30,29,35,36,37)),'type'=>1);
        $xjyb=M("cash")->where(array("branch"=>array('in',array(30,29,35,36,37)),'type'=>1))->sum("money");
        ...
        //速贷
        $where=array("starttime"=>array(array('gt',strtotime(date('Y-m-01 0:00:01'))),array("elt",mktime(23,59,59,date('m'),date('t'),date('Y')))));
        $where[]=array("branch"=>array('in',array(30,29,35,36,37)),'type'=>2);
        $xjyb=M("cash")->where(array("branch"=>array('in',array(30,29,35,36,37)),'type'=>2))->sum("money");
        $xjybs=M("cash")->where($where)->sum("money");
        $xjyb=$xjyb/10000;
        $xjyb=substr(sprintf("%.3f",$xjyb),0,-1);
        $xjybs=$xjybs/10000;
        ...
        //速分贷
        $where=array("starttime"=>array(array('gt',strtotime(date('Y-m-01 0:00:01'))),array("elt",mktime(23,59,59,date('m'),date('t'),date('Y')))));
        $where[]=array("branch"=>array('in',array(18,19,39)),'type'=>1);
        $xjeb=M("cash")->where(array("branch"=>array('in',array(18,19,39)),'type'=>1))->sum("money");
        ...
        //速贷
        $where=array("starttime"=>array(array('gt',strtotime(date('Y-m-01 0:00:01'))),array("elt",mktime(23,59,59,date('m'),date('t'),date('Y')))));
        $where[]=array("branch"=>array('in',array(18,19,39)),'type'=>2);
        $xjeb=M("cash")->where(array("branch"=>array('in',array(18,19,39)),'type'=>2))->sum("money");
        $xjebs=M("cash")->where($where)->sum("money");
        $xjeb=$xjeb/10000;
        $xjeb=substr(sprintf("%.3f",$xjeb),0,-1);
        $xjebs=$xjebs/10000;
